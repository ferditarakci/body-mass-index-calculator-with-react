  ...
  const handleSubmit = async (e) => {
    ...
    if (!isValidate) {
      ...
      const dbResult = await (
        await fetch(`api/bmi_${gender === 1 ? 'girl' : 'boy'}_db.json`)
      ).json()
      ...
      <Grid container spacing={1.5}>
        ...
        <Grid item xs={6} md={2}>
          <FormControl fullWidth>
            <TextField
              ...
              name="height"
              onInput={(e) =>
                setForm({ ...form, height: parseFloat(e.target.value.replace(/,/i, '.')) })
              }
        ...
        <Grid item xs={6} md={2}>
          <FormControl fullWidth>
            <TextField
              ...
              name="weight"
              onInput={(e) =>
                setForm({ ...form, weight: parseFloat(e.target.value.replace(/,/i, '.')) })
              }
              inputProps={numericInput}
        ...
        <Grid item xs={12}>
          ...
          {result.index && (
            <Typography
              variant="h2"
              style={{ marginBottom: 0, color: result.color }}
              align="center"
            >
              {result.index}
            </Typography>
          ...
          {result.title && (
            <Typography
              variant="h2"
              style={{ fontSize: '2rem', marginBottom: '1rem', color: result.color }}
              align="center"
            >
              {result.title}
            </Typography>
